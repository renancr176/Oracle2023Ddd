...
public abstract class RepositoryAutoIncrementId<TDbContext, TEntity> : Repository<TDbContext, TEntity>, IRepositoryAutoIncrementId<TEntity>
    where TDbContext : DbContext, IUnitOfWork
    where TEntity : EntityAutoIncrementId
{
    protected RepositoryAutoIncrementId(TDbContext context)
        : base(context)
    {
    }
...
public abstract class RepositoryStringId<TDbContext, TEntity> : Repository<TDbContext, TEntity>, IRepositoryStringId<TEntity>
    where TDbContext : DbContext, IUnitOfWork
    where TEntity : EntityStringId
{
    protected RepositoryStringId(TDbContext context)
        : base(context)
    {
    }
